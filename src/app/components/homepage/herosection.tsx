      ...
      <div className="flex items-center justify-center min-h-screen relative z-10">
        <main className="flex flex-row gap-8 items-center pb-10 border-b-[1px] border-gray-300">
          <div className="flex flex-col w-[60%] gap-[70px]">
            ...
            <a className="bg-white/80 rounded-xl py-7 text-black text-xl flex justify-center items-center cursor-pointer text-center hover:bg-white transition-colors transition duration-300"
